...
public class Ship {
	...
	/**
	 * Attribute minimumCrewNum is an integer which stores a Ship object's 
	 * minimum crew number.
	 */
	private int minimumCrewNum;
	
	/**
	 * Attribute costPerSailor is an integer which stores how much to pay one 
	 * sailor per day.
	 */
	...
	/**
	 * Attribute cargos is an ArrayList which holds the {@link Item} objects
	 * which {@link Trader} buy from {@link Store}.
	 */
	private ArrayList<Item> cargos;

	/**
	 * Attribute defaultCapacity is an integer which stores the default capacity
	 * of this Ship object.
	 */
	private int defaultCapacity;

	/**
	 * Attribute remainingCapacity is an integer which stores the current
	 * capacity (defaultCapacity minus total weight of bought items) of this 
	 * Ship object.
	 */
	...
	/**
	 * Attribute maxCannons is an integer which stores the maximum number of 
	 * the cannons of this Ship object.
	 */
	...
	/**
	 * Attribute speed is a string which stores a description of the speed of 
	 * this Ship object.
	 */
	private String speed;
	
	/**
	 * Attribute shipSailingModifier is an integer which stores a value corresponding
	 * to this Ship object's speed description. This attribute is used to modify
	 * the sailing days of this Ship object between {@link Island}s.
	 */
	private int shipSailingModifier;
	
	/**
	 * Attribute upgradeLogs is an ArrayList which stores all the {@link UpgradeLog}s 
	 * (including repair services and cannon upgrade service) of this Ship object.
	 */
	...
	/**
	 * This method formats a string report of the cargos on this {@link Ship}
	 * object by iterating all the {@link Item}s stored in cargos attribute.
	 ...
	 * object by iterating all the {@link UpgradeLog}s stored in upgradeLogs attribute.
	 * @return a string describing the contents of the upgrade logs of this {@link Ship}
	 * object.
	 */
	...
	/**
	 * This method iterates the ArrayList stored in cargos attribute to check
	 * if there is an {@link Item} object with the name itemName. 
	 ...
	 * @param amount an iteger value t
	 */
